...
String DBFixEdge      = "ujicoba/FixEdge/";
...
String getBlowerLev4 = DBLocationSetting + "level4";
...
//blower kontrol
String blowerLev1, blowerLev2, blowerLev3, blowerLev4;
String levelBlower;
...
void setup() {
  ...
  blowerLev4    = Firebase.getString(getBlowerLev4);
